...
def unload_one_good(dw:WD, lc_link_on_good: str, pc_price:str):
    ...
    print(f'{Fore.YELLOW}Цены: {Fore.LIGHTCYAN_EX}{lo_good.prices}{Fore.RESET}')
    ...
    print(f'{Fore.YELLOW}Размеры: {Fore.LIGHTGREEN_EX}{lo_good.sizes}{Fore.RESET}')
    print(f'{Fore.YELLOW}Цвета: {Fore.LIGHTCYAN_EX}{lo_good.colors}{Fore.RESET}')
    return lo_good
